import heroBg from '../assets/images/login/hero-bg.png';
import heroMoong from '../assets/images/login/hero-moong.png';
import heroShadow from '../assets/images/login/hero-shadow.png';
import kakaoLogo from '../assets/icons/login/kakao-logo.svg'
        ...
        <div className="bg-custom-bg flex justify-center items-center w-full h-screen font-sans">
            <div className="flex flex-col justify-center items-center md:w-[28rem] 2xl:w-[35rem]">
                ...
                <div className="bg-white relative w-full aspect-[13/9] md:mb-[3.1rem] 2xl:mb-[3.5rem] after:content-[''] after:absolute after:z-[4] after:inset-0 after:shadow-[inset_80px_0_45px_-25px_#121212,inset_-80px_0_45px_-25px_#121212]">
                    <img src={heroBg} className="absolute w-full h-full object-cover z-[1]" alt="bg" />
                    <img src={heroMoong} className="absolute top-[10%] left-[25%] w-[50%] z-[3]" alt="moong" />
                    <img src={heroShadow} className="absolute top-[78%] left-[20%] w-[60%] z-[2]" alt="shadow" />
                </div>
