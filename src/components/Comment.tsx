...
export const Comment = () => {
    ...
    return (
        <aside className='absolute top-0 right-0 md:w-66 2xl:w-90 h-full bg-[#272727] flex flex-col gap-2 z-40'>
            ...
            <footer className='bg-[#393939]'>
                <div className='relative flex items-end'>
                    ...
                    />
                    <button className='absolute md:bottom-5 2xl:bottom-6 right-6 text-black cursor-pointer'>
                        d^
                    </button>
                </div>
            </footer>
